...
// 🟢 Helper to check if a product is a Laddu
export const isLadduProduct = (p) => {
  if (!p) return false;
  ...
  return (
    ...
    combined.includes('gond') ||
    combined.includes('pinni')
  );
};
    ...
    >
      ...
      <div className="sg-card-top-bar" style={{ position: 'relative', zIndex: 6 }}>
        {outOfStock ? (
          ...
          <span className="sg-badge-category-mini">LADDU</span>
        )}
      ...
      >
        <span>📍 Handcrafted in {product.originRegion || 'Jodhpur, Rajasthan'}</span>
      </div>
...
const LadduPage = ({ addToCart, addedToast }) => {
  ...
  const sortedLaddus = [...products].sort((a, b) => {
  ...
  return (
    <div className="sg-homepage-container">
              ...
              <div className="sg-modal-info-col">
                <div>
                  <div className="sg-modal-tags-row">
                    ...
                    <span className="sg-badge-category">DESI GHEE LADDU</span>
                  </div>
      ...
      {/* Header Banner for Laddu Page */}
      <section className="sg-container" style={{ marginTop: '24px' }}>
        <div className="sg-section-heading-wrap sg-text-center">
          <span className="sg-sub-heading">Pure Desi Ghee Handcrafted</span>
          <h1 className="sg-main-heading">🟡 Royal Laddu Collection</h1>
          <p style={{ color: '#64748b', fontSize: '0.9rem', marginTop: '6px' }}>
            Prepared fresh daily using 100% pure cow desi ghee and time-tested village recipes.
          </p>
        </div>
      </section>
      ...
      <section className="sg-products-section sg-container">
        ...
        ) : sortedLaddus.length === 0 ? (
          <div className="sg-empty-category-card">
            <h3>No Laddus currently available!</h3>
