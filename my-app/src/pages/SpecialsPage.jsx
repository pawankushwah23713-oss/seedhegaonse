...
export const isSpecialsProduct = (p) => {
  if (!p) return false;
...
const SpecialsPage = ({ addToCart, addedToast }) => {
    ...
    <div className="sg-homepage-container">
              ...
              <div className="sg-modal-info-col">
                <div>
                  <div className="sg-modal-tags-row">
                    ...
                    <span className="sg-badge-category">⭐ SPECIAL</span>
                  </div>
                  ...
                  <p className="sg-modal-desc">
                    {selectedProduct.description || 'Authentic festive sweet prepared using traditional recipes with no artificial flavours or preservatives.'}
                  </p>
                </div>

                <div className="sg-modal-trust-checklist">
                  <div className="sg-trust-check-item">✓ 100% Authentic Recipe</div>
                  <div className="sg-trust-check-item">✓ 0 Preservatives Added</div>
                  <div className="sg-trust-check-item">✓ Shelf Life: 5-7 Days</div>
      ...
      <section className="sg-container" style={{ marginTop: '24px' }}>
        <div className="sg-section-heading-wrap sg-text-center">
          <span className="sg-sub-heading">Festive & Royal Treats</span>
          <h1 className="sg-main-heading">⭐ Special Delights Collection</h1>
          <p style={{ color: '#64748b', fontSize: '0.9rem', marginTop: '6px' }}>
            Jaipuri Rabdi Ghewar, Kesar Rasgulla, Shahi Gulab Jamun & seasonal specialty sweets.
          </p>
        </div>
      </section>
                ...
                >
                  ...
                  <div className="sg-card-top-bar" style={{ position: 'relative', zIndex: 6 }}>
                    {out ? (
                      ...
                      <span className="sg-badge-category-mini">⭐ SPECIAL</span>
                    )}
