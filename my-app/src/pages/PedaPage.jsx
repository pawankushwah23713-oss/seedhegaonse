...
// 🟢 Helper to check if a product is a Peda
export const isPedaProduct = (p) => {
  if (!p) return false;
  ...
  return (
    ...
    combined.includes('malai peda') ||
    combined.includes('doodh peda')
  );
};
    ...
    >
      ...
      <div className="sg-card-top-bar" style={{ position: 'relative', zIndex: 6 }}>
        {outOfStock ? (
          ...
          <span className="sg-badge-category-mini">PEDA</span>
        )}
      ...
      >
        <span>📍 Handcrafted in {product.originRegion || 'Mathura, UP'}</span>
      </div>
...
const PedaPage = ({ addToCart, addedToast }) => {
  ...
  const sortedPedas = [...products].sort((a, b) => {
  ...
  return (
    <div className="sg-homepage-container">
              ...
              <div className="sg-modal-info-col">
                <div>
                  <div className="sg-modal-tags-row">
                    ...
                    <span className="sg-badge-category">AUTHENTIC PEDA</span>
                  </div>
                  ...
                  <p className="sg-modal-desc">
                    {selectedProduct.description || 'Authentic slow-roasted khoya peda prepared using traditional village methods with no artificial colours or preservatives.'}
                  </p>
                </div>

                <div className="sg-modal-trust-checklist">
                  <div className="sg-trust-check-item">✓ 100% Pure Buffalo Milk Khoya</div>
                  <div className="sg-trust-check-item">✓ 0 Preservatives Added</div>
                  <div className="sg-trust-check-item">✓ Shelf Life: 10-15 Days</div>
      ...
      {/* Header Banner for Peda Page */}
      <section className="sg-container" style={{ marginTop: '24px' }}>
        <div className="sg-section-heading-wrap sg-text-center">
          <span className="sg-sub-heading">Authentic Khoya & Malai</span>
          <h1 className="sg-main-heading">🟤 Royal Mathura Peda Collection</h1>
          <p style={{ color: '#64748b', fontSize: '0.9rem', marginTop: '6px' }}>
            Slow-simmered rich caramelized milk & khoya delights prepared with aromatic green cardamom.
          </p>
        </div>
      </section>
      ...
      <section className="sg-products-section sg-container">
        {loading && products.length === 0 ? (
          <div className="sg-empty-loading-state">
            ...
            <h3>🟤 Loading fresh authentic pedas...</h3>
          </div>
        ) : sortedPedas.length === 0 ? (
          <div className="sg-empty-category-card">
            <h3>No Pedas currently available!</h3>
