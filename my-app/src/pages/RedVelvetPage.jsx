...
const FALLBACK_CAKE_IMG = 'https://images.unsplash.com/photo-1586788680434-30d324b2d46f?q=80&w=600&auto=format&fit=crop';
...
const RedVelvetPage = ({ addToCart, addedToast }) => {
              ...
              <div className="ck-modal-info-col">
                <div>
                  <div className="ck-modal-tags-row">
                    ...
                    <span className="ck-badge-category">❤️ RED VELVET</span>
                  </div>
                  ...
                  <p className="ck-modal-desc">
                    {selectedProduct.description || 'Velvety crimson sponge paired with authentic cream cheese frosting. Free birthday candle and knife included.'}
                  </p>
                ...
                >
                  ...
                  <div className="ck-card-top-bar" style={{ position: 'relative', zIndex: 6 }}>
                    {out ? (
                      ...
                      <span className="ck-badge-category-mini">❤️ RED VELVET</span>
                    )}
                    <button
                      type="button"
